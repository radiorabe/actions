...
Scans the latest container image with Trivy at regular intervals and attaches a security
attestation to the image.
...
5. Replace this with the actual name of the image.
...
2. Skip uploading scan results to the GitHub Security tab.
3. Skip attaching a cosign vulnerability attestation to the image.

...
Builds and deploys [Zensical](https://zensical.org/) documentation to GitHub Pages.
[Zensical](https://zensical.org/) is a modern static site generator built by the creators of
[Material for MkDocs](https://squidfunk.github.io/mkdocs-material/) and is the recommended
replacement for [release-mkdocs.yaml](mkdocs.md).
...
[Zensical compatibility guide](https://zensical.org/compatibility/) for details.
...
3. Required to deploy to GitHub Pages via the Actions Pages API.
4. Required to authenticate with the GitHub Pages OIDC endpoint.

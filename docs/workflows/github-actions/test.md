...
Runs [zizmor](https://github.com/zizmorcore/zizmor) static analysis security testing (SAST)
on GitHub Actions workflow files. Results are uploaded to the repository's security tab as a
SARIF report when GitHub Advanced Security is available.

...
1. Add the workflow to the permissions table in `docs/permissions.md`.
...
1. After the deprecation window (at least one minor release), remove the workflow file, its documentation page, its entry in `mkdocs.yml`, and its row in `docs/permissions.md`.
